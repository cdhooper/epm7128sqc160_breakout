...
Atmel ATF1508 QC160. The board is known by the nickname Avocado or
Holy Guacamole. :evergreen_tree: So, :cactus: if :four_leaf_clover: you :green_apple: make :pear: your :melon: own, :white_check_mark: make it :heavy_dollar_sign: :dragon: GREEN :green_heart:.
